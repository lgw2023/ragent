"""
Centralized configuration constants for ragent.

This module defines default values for configuration constants used across
different parts of the ragent system. Centralizing these values ensures
...
DEFAULT_KEYWORD_CACHE_TOP_K = 20
...
DEFAULT_LOG_FILENAME = "ragent.log"  # Default log filename
